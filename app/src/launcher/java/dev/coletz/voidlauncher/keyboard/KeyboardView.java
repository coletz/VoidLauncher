...
import dev.coletz.voidlauncher.keyboard.Keyboard.Key;
...
public class KeyboardView extends View implements View.OnClickListener {
    ...
    public KeyboardView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, R.style.KeyboardView);
    }
    public KeyboardView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.KeyboardView, defStyleAttr, defStyleRes);
        ...
        if (mAccessibilityManager.isEnabled()) {
            ...
            switch (code) {
                ...
                case Keyboard.KEYCODE_MODE_CHANGE:
                    ...
                    break;
                case Keyboard.KEYCODE_SHIFT_LEFT:
                case Keyboard.KEYCODE_SHIFT_RIGHT:
