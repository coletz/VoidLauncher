...
public class Keyboard {
    ...
    public static final int KEYCODE_SHIFT_LEFT = -10;
    public static final int KEYCODE_SHIFT_RIGHT = -20;
    public static final int KEYCODE_MODE_CHANGE = -2;
    public static final int KEYCODE_CANCEL = -3;
    public static final int KEYCODE_DONE = -4;
    public static final int KEYCODE_DELETE = -5;
    public static final int KEYCODE_ALT = -6;
    public static final int KEYCODE_CUSTOM_NOTIFICATION = -9001;
    public static final int KEYCODE_CUSTOM_RECENT = -9002;
    public static final int KEYCODE_CUSTOM_VOICE_RECORD = -9003;
    public static final int KEYCODE_CUSTOM_CURRENCY = -9004;
            ...
            while ((event = parser.next()) != XmlResourceParser.END_DOCUMENT) {
                if (event == XmlResourceParser.START_TAG) {
                    ...
                    if (TAG_ROW.equals(tag)) {
                        ...
                        mKeys.add(key);
                        if (key.codes[0] == KEYCODE_SHIFT_LEFT || key.codes[0] == KEYCODE_SHIFT_RIGHT) {
